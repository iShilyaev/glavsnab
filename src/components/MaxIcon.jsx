...
export default function MaxIcon({ className = 'h-8 w-8' }) {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={fill} x1="117.847" x2="1000" y1="760.536" y2="500" gradientUnits="userSpaceOnUse">
      ...
      <rect width="1000" height="1000" fill={`url(#${fill})`} ry="249.681" />
      <rect width="1000" height="1000" fill={`url(#${shine})`} ry="249.681" />
      <path
        fill="#fff"
        fillRule="evenodd"
        clipRule="evenodd"
